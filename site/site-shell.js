(() => {
  ...
  const copy = isChinese
    ? {
        ...
        newsItems: [
          ["关于 R&M", "news.html#about-rm"],
          ["客户与交付案例", "news.html#case-studies"],
          ["食品安全与合规", "news.html#compliance"],
          ["产品与餐饮应用", "news.html#applications"],
          ["展会动态", "news.html#trade-shows"],
        ],
    ...
    : {
        ...
        newsItems: [
          ["About R&M", "news.html#about-rm"],
          ["Customer & Delivery Cases", "news.html#case-studies"],
          ["Food Safety & Compliance", "news.html#compliance"],
          ["Product & Foodservice Applications", "news.html#applications"],
          ["Trade Show Updates", "news.html#trade-shows"],
        ],
